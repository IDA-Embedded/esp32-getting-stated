...
#define SYSTEM_CTROL0 \
	0x3008 // Bit[7]: Software reset
...
#define FRAME_CTRL01 \
	0x4201 // Control Passed Frame Number When both ON and OFF number set to 0x00,frame control is
		   // in bypass mode Bit[7:4]: Not used Bit[3:0]: Frame ON number
#define FRAME_CTRL02 \
	0x4202 // Control Masked Frame Number When both ON and OFF number set to 0x00,frame control is
		   // in bypass mode Bit[7:4]: Not used BIT[3:0]: Frame OFF number

/* ISP top control registers */
#define PRE_ISP_TEST_SETTING_1 \
	0x503D // Bit[7]: Test enable
		   //         0: Test disable
		   //         1: Color bar enable
		   // Bit[6]: Rolling
		   // Bit[5]: Transparent
...
#define AEC_PK_MANUAL \
	0x3503 // AEC Manual Mode Control
		   // Bit[7:6]: Reserved
...
#define TIMING_TC_REG20 \
	0x3820 // Timing Control Register
		   // Bit[2:1]: Vertical flip enable
		   //         00: Normal
		   //         11: Vertical flip
		   // Bit[0]: Vertical binning enable
#define TIMING_TC_REG21 \
	0x3821 // Timing Control Register
...
#define CLOCK_POL_CONTROL \
	0x4740 // Bit[5]: PCLK polarity 0: active low
		   //          1: active high
...
#define X_INCREMENT \
	0x3814 // Bit[7:4]: Horizontal odd subsample increment
		   // Bit[3:0]: Horizontal even subsample increment
#define Y_INCREMENT \
	0x3815 // Bit[7:4]: Vertical odd subsample increment
...
#define ISP_CONTROL_01 \
	0x5001 // Bit[5]: Scale enable
		   //          0: Disable
		   //          1: Enable

#define SCALE_CTRL_1 \
	0x5601 // Bit[6:4]: HDIV RW
		   //          DCW scale times
		   //          000: DCW 1 time
		   //          001: DCW 2 times
		   //          010: DCW 4 times
...
#define VFIFO_CTRL0C \
	0x460C // Bit[1]: PCLK manual enable
		   //          0: Auto
...
#define SC_PLLS_CTRL2 \
	0x303c // Bit[6:4]: PLLS charge pump control
		   // Bit[3:0]: PLLS system divider
#define SC_PLLS_CTRL3 \
	0x303d // Bit[5:4]: PLLS pre-divider
		   //          00: 1
		   //          01: 1.5
		   //          10: 2
		   //          11: 3
